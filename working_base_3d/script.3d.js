class TerrainMap {
    ...
    initSidePanel() {
        ...
        sidePanel.innerHTML = `
            <div class="panel-header">
                <div class="panel-title">MTB Trails</div>
    ...
    async fetchMTBTrails() {
        try {
            ...
            // Query for mountain biking trails
            const query = `
                [out:json][timeout:25];
                (
            ...
            // Process trails
            const trails = data.elements.filter(e => e.type === 'way' && e.tags && e.tags['mtb:scale']);
            const trailFeatures = [];
            ...
            trails.forEach((trail, index) => {
                ...
                const difficulty = parseInt(trail.tags['mtb:scale']) || 0;
    ...
    addTrailListItem(trail) {
        ...
        item.innerHTML = `
            ...
            <div class="trail-details">
                Difficulty: ${trail.properties.difficulty}/6<br>
