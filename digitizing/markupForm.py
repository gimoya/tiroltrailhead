...
def newDescr():
	descrField.setPlainText('<div id="topic">Name:</br>Region:</br>H&ouml;hendifferenz:</br>Schwierigkeit:</br>Gefahr:</br>Uphill:</br>Erlebnis:</br>Aufstiegshilfe:</br>Konflikt:</div><div id="topic-text">' +	
